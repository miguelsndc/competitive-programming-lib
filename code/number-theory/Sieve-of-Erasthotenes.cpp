...
Sieve of Erasthotenes
    Consulta rápida de números primos
    Complexidade: O(nlog(log(n)))
    Calcula o maior divisor primo de cada número
*/
...
// Fatoração prima de `n` com sieve O(log(n))
...
// Soma dos divisores de todos os numero de 1 até LIM - 1
ll sumDivisors[LIM];
void sum_div()
{
    for (int i = 1; i < LIM; i++) {
...
// Número dos divisores de todos os numero de 1 até LIM - 1
ll numDivisors[LIM];
void num_div()
{
    for (int i = 1; i < LIM; i++) {
